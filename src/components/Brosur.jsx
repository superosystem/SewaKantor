      ...
      >
        <Box>
          <Typography variant="h4" gutterBottom>
            Download. Get your Vaccine. <br />
            Save life. Protect from virus!
          </Typography>
          <Button variant="contained" sx={{ mt: 2, width: "max-content" }}>
            Get It Now
          </Button>
        </Box>
      </Box>
        ...
        <Stack sx={{ position: "relative", pt: 4 }} spacing={2}>
          <Stack
            sx={{
              ...
              color: "softInfo.text",
              transform:
                mobile || tablet ? "translate(100%, 0)" : "translate(135%, 0)",
              p: 1,
            }}
          >
            <Typography variant="h5">10k+</Typography>
            <Typography gutterBottom>The user has been registered</Typography>
          </Stack>
          <Stack
            sx={{
              borderRadius: 2,
              ...
              transform:
                mobile || tablet ? "translate(90%, 0)" : "translate(120%, 0)",
              p: 1,
            }}
          >
            <Typography variant="h5">8k+</Typography>
            <Typography>Vaccination has been served</Typography>
          </Stack>
        </Stack>
        <Card
          sx={{
        ...
        >
          <CardContent>
            <Stack spacing={1}>
              ...
              This application makes it very easy for me and my family to find a place and get vaccinated quickly.
              </Typography>
              <Stack
                direction={"row"}
                spacing={1}
