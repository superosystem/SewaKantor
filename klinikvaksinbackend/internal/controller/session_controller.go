...
func NewSessionsController(sessionServ service.SessionsService) *SessionsController {
...
func (s *SessionsController) CreateSession(ctx echo.Context) error {
	var payloads payload.SessionPayload
...
func (s *SessionsController) UpdateSession(ctx echo.Context) error {
	var payloads payload.SessionUpdate
...
func (s *SessionsController) IsCloseSession(ctx echo.Context) error {
	var payloads payload.SessionIsClose
	id := ctx.Param("id")
