...
type VaccinesController struct {
	VaccineService service.VaccinesService
}

func NewVaccinesController(vaccineServ service.VaccinesService) *VaccinesController {
...
func (v *VaccinesController) CreateVaccine(ctx echo.Context) error {
	var payloads payload.VaccinePayload
...
func (v *VaccinesController) UpdateVaccine(ctx echo.Context) error {
	var payloads payload.VaccineUpdatePayload
