...
import ModalAddEditStock from "../../components/modals/ModalAddEditStock";
import ModalDeleteVaksin from "../../components/modals/ModalDeleteVaksin";
...
const columns = [
  ...
  {field: 'name', headerName: 'VAccine Name', width: 220, align: 'center', headerAlign: 'center'},
  {field: 'dose', headerName: 'Doses', width: 200, align: 'center', headerAlign: 'center'},
  {
    field: 'stock', 
    headerName: 'Vaccine Stock', 
    width: 220,
    align: 'center', 
    headerAlign: 'center',
    renderCell: (props) =>{
