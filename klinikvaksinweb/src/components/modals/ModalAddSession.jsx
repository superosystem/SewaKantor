...
const ModalAddSession = () => {
  ...
  const doseAvailability = (dose) => {
    return vaksinData.some(
      ({ Name, Dose }) => Name === formData.vaccine_name && Dose === dose
    );
  };
  ...
  useEffect(() => {
    ...
    if (vaccine_name && dose) {
      const [selectedVaccine] = vaksinData.filter(
        ({ Name, Dose }) => Name === vaccine_name && Dose === dose
      );
      setFormData({
        ...formData,
  ...
  return (
    <>
      ...
      >
        <DialogTitle align="center">Add Session</DialogTitle>
        <DialogContent
          sx={{
            ...hideScroller,
          }}
          ...
          <Stack>
            <FormControl fullWidth>
              <Stack spacing={2} sx={{ mt: 1 }}>
                ...
                />
                <FormControl fullWidth>
                  <InputLabel id="dropdown-jenis-vaksin-label">
                    Vaccine Brand
                  </InputLabel>
                  <Select
                ...
                <FormControl>
                  <InputLabel id="dropdown-time-vaksin-label">Time</InputLabel>
                  <Select
                    ...
                    onChange={handleChange}
                  >
                    <MenuItem value="08.00 - 11.00 WIB">
                      08.00 - 11.00 WIB
                    </MenuItem>
                    <MenuItem value="13.00 - 16.00 WIB">
                      13.00 - 16.00 WIB
                    </MenuItem>
                  </Select>
                </FormControl>
                <FormControl>
                  <InputLabel id="dropdown-dose-vaksin-label">Doses</InputLabel>
                  <Select
                ...
                <TextField
                  ...
                  onChange={handleChange}
                  helperText={
                    maxCapacity > 0 && `Capacity maks. ${maxCapacity}`
                  }
                />
              </Stack>
            </FormControl>
