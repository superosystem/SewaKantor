...
import {
  ...
  getVaksinList,
  updateStock,
} from "../../store/features/vaksin/vaksinSlice";
    ...
    <>
      ...
      <Dialog fullWidth maxWidth="xs" open={open} onClose={handleClose}>
        <DialogTitle sx={{ alignSelf: "center" }}>
          {edit ? "Edit" : "Add"} Vaccine Stock
        </DialogTitle>
        <DialogContent>
          <Stack spacing={3} sx={{ py: 2 }}>
            <FormControl fullWidth>
              <InputLabel id="label-vaksin">Vaccine</InputLabel>
              <Select
                label="Vaccine"
                disabled={edit}
                id="select-vaksin"
            ...
            <FormControl fullWidth>
              <InputLabel id="label-dose">Doses</InputLabel>
              <Select
                label="Vaccine"
                disabled={edit || name === ""}
                id="select-dose"
        ...
        <DialogActions sx={{ p: 3 }}>
          ...
          <Button
            ...
            disabled={disabled}
            onClick={() => {
              edit ? handleEdit(formData) : handleSubmit(formData);
            }}
          >
            {edit ? "Save" : "Add"}
          </Button>
